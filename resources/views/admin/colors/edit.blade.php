...
@section('title')
    <span class="titlescc">@lang('trs.edit_color')</span>
@endsection

@section('content')
    <div class="row justify-content-center" style="margin-top:5%">
        <div class="col-md-8 cardbank  bankadd" style="">
            <div class="card mb-4"><h5 class="card-header">@lang('trs.edit_color')</h5>
                            ...
                            <div class="col-6 mg-b-10">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-start" id="title" name="title" dir="rtl"
                                           placeholder="" value="{{$color->title}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-12 mg-b-10">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control text-start" id="description"
                                              name="description" dir="rtl">{{$color->description}}</textarea>
                                </div>
                            </div>
                        </div>
