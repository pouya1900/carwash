...
@section('title')
    <span class="titlescc">@lang('trs.edit_brand')</span>
@endsection

@section('content')
    <div class="row justify-content-center" style="margin-top:5%">
        <div class="col-md-8 cardbank  bankadd" style="">
            <div class="card mb-4"><h5 class="card-header">@lang('trs.edit_brand')</h5>
                            ...
                            <div class="col-6 mg-b-10">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control text-start" id="title" name="title" dir="rtl"
                                           placeholder="" value="{{$brand->title}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-12 mg-b-10">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control text-start" id="description"
                                              name="description" dir="rtl">{{$brand->description}}</textarea>
                                </div>
                            </div>
                                ...
                                @foreach($types as $type)
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" name="types[]" type="checkbox"
                                            ...
                                            {{in_array($type->id,$brand->types()->pluck('types.id')->toArray()) ? "checked" : ""}}
                                        >
                                    </div>
                                @endforeach
                            ...
                            <div class="col-12">
                                ...
                                <div id="app">
                                    <image-input-preview att_name="logo"
                                                         src="{{$brand->logo["model"] ? $brand->logo["paths"]["standard"] : ""}}">
                                    </image-input-preview>
                                </div>
                            </div>
