...
@section('title')
    <span class="titlescc">@lang('trs.types')</span>
@endsection

@section('content')
    <div class="card ticket">
        <h5 class="card-header">@lang('trs.types_list')</h5>
                ...
                <table class="table txtcenter" style="width: 95%">
                    ...
                    @foreach($types as $key=>$type)
                        <tr>
                            ...
                            <td data-th="عنوان">{{ $type->title }}</td>
                            <td data-th="توضیحات">{{ $type->description}}</td>
                            <td data-th="مدیریت">
                                <ul class="ulinlin fsize13">
                                    <li>
                                        <button style="background:none;border: none;"
                                                onclick='functionConfirm("آیا از حذف نوع وسیله نقلیه اطمینان دارید ؟", function yes() {
                                                    window.location.replace("{{route('admin.type.remove',$type->id)}}");
                                                    },
                                                    function no() {
                                                    });'>حذف
                                        </button>
                                    ...
                                    <li class="mgright10"><a class="no_hover_a"
                                                             href="{{route('admin.type.edit',$type->id)}}">ویرایش</a>
                                    </li>
                                </ul>
                                <div id="confirm">
