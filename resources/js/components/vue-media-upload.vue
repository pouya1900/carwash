<template>
    <div>
        <div class="mu-container" :style="cssProps" :class="isInvalid?'mu-red-border':''">
            <Loader
                color="#0275d8"
                :active="isLoading"
                spinner="line-scale"
...
export default {
    ...
    computed: {
        ...
        cssProps() {
            return {
                '--bg-file-color': this.style.backgroundColor,
            }
        }
    },
    emits: [
...
.mu-container {
    background-color: var(--bg-file-color) !important;
